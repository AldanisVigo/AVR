...
/*
 * Receives a character through the receiver interface.
 * 
 * @param (FILE *) stream
 * @return (int)
 */
...
/*
 * Receives a string through the receiver interface of a set length
 *
 * @param (const uint16_t) length, (unsigned char *) response
